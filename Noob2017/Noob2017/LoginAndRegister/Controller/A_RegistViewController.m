...
-(void)createUI {
    ...
    self.codenBtn = [KCKit createBtnWithFrame:CGRectMake(CGRectGetMaxX(userBg.frame)+10, CGRectGetMinY(userBg.frame), (WIDTH-userBg_X*2)*.3, CGRectGetHeight(userBg.frame)) Text:@"获取验证码" TextColor:Kffffff TextFontSize:14*SizeScale bgColor:K2088e2 Target:self method:@selector(testGetCoden)];
